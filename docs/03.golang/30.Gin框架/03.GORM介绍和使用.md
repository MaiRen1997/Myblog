...
![image-20200917213143434](./img/image-20200917213143434.png)

结构体 和 SQL数据库存在映射，这个时候就有了ORM语句

![image-20200917213229165](./img/image-20200917213229165.png)

一句话说：就是将数据库中的表数据 和 结构体进行对应的关系

![image-20200917213306696](./img/image-20200917213306696.png)
