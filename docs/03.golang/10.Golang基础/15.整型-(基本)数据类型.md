...
3. 分类
   ...
   - 32位操作系统：int  -> int32
   - 64位操作系统：int -> int64
   - ![image-20200719084018801](./img/image-20200719084018801.png)
...
1. 示例
   ...
   fmt.Printf("%x\n", number)
   // 保存为字符串
   binStr := fmt.Sprintf("%b", number)   // "11111111"
   octStr := fmt.Sprintf("%o", number)   // "377"
   hexStr := fmt.Sprintf("%x", number)   // "ff"
   decStr := fmt.Sprintf("%d", number)   // "255"
   ```
